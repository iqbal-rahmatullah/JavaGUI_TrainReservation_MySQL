...
public class KeretaController {
    ...
    public static void SearchKereta(JComboBox asalField, JComboBox tujuanField, JDateChooser tanggalField, JComboBox ticketField, String tipe) {
        ...
        SelectKereta pageSelect = new SelectKereta(asal, tujuan, Integer.parseInt(jumlahTicket), tipe);
    ...
    public void displayButtonKereta(JPanel panel, List<Kereta> allKereta, int jumlahTicket, String tipe, JFrame keretaFrame) {
        int y = 20;
        for (Kereta kereta : allKereta) {
            ...
            pickKereta.addActionListener(new handleButtonKereta(kereta, jumlahTicket, tipe,  keretaFrame));
     ...
     class handleButtonKereta implements ActionListener {
        ...
        public handleButtonKereta(Kereta kereta, int jumlahTicket, String tipe, JFrame selectKeretaFrame) {
            this.kereta = kereta;
        ...
        public void actionPerformed(ActionEvent e) {
            SelectSeat seatFrame = new SelectSeat(kereta, jumlahTicket, tipe);
